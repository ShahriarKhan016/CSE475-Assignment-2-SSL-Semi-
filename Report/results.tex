...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{assignment1/yolov12_results.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{assignment1/yolov12_confusion_matrix_normalized.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{assignment1/yolov12_BoxPR_curve.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{assignment2/ssod/model_comparison.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{assignment2/ssod/pseudo_label_analysis.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{assignment2/ssod/baseline_results.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{assignment2/simclr/simclr_training_curves.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{assignment2/simclr/simclr_tsne.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{assignment2/simclr/simclr_confusion_matrices.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{assignment2/simclr/simclr_per_class_metrics.png}
...
The pretrained SimCLR backbone was integrated with YOLOv12 for object detection tasks, achieving \textbf{91.89\% mAP@0.5} and \textbf{65.09\% mAP@0.5:0.95}.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{assignment2/simclr_yolo_predictions.png}
    \caption[SimCLR + YOLOv12 detection results]{SimCLR + YOLOv12 detection results showing bounding box predictions with class labels and detection counts.}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{assignment2/dinov3/dinov3_yolo_results.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{assignment2/dinov3/dinov3_yolo_confusion.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{assignment2/dinov3/dinov3_yolo_predictions.png}
...
Figure \ref{fig:qualitative_sample} presents additional qualitative results from the best performing model on the test set.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{results_sample.png}
    \caption{Qualitative detection results on test samples. The model accurately localizes tumors and fluid collections with high confidence scores, demonstrating robustness across different brain MRI slices.}
    \label{fig:qualitative_sample}
\end{figure}
...
\midrule
\multirow{2}{*}{Self-Supervised} & SimCLR + YOLO & 91.89\% & 65.09\% & 84.35\% \\
